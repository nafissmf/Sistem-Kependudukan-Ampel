...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Manajemen Role']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Manajemen Role']); ?>
    <?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Manajemen Role','description' => 'Daftar role dan hak akses dalam sistem.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Manajemen Role','description' => 'Daftar role dan hak akses dalam sistem.']); ?>
...
<?php endif; ?>
                    ...
                    <span class="rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-600 dark:bg-white/10 dark:text-slate-300">
                        <?php echo e($role->users_count); ?> pengguna
                    </span>
                </div>
                <h3 class="mt-3 font-display font-semibold" style="font-family: var(--font-display);"><?php echo e($role->name); ?></h3>
                <p class="mt-1 text-sm text-slate-500"><?php echo e($role->description ?? 'Tidak ada deskripsi.'); ?></p>
                <div class="mt-3 flex items-center gap-1 text-xs font-medium text-primary-600 group-hover:text-primary-700 dark:text-primary-400">
                    Lihat hak akses <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?>
<?php /**PATH D:\Portofolio\sik-ampel-laravel\resources\views/roles/index.blade.php ENDPATH**/ ?>