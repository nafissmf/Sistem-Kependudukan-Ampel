...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Data Rumah']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Data Rumah']); ?>
    <?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Data Rumah','description' => 'Kelola data rumah dan koordinat GPS-nya.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Data Rumah','description' => 'Kelola data rumah dan koordinat GPS-nya.']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rumah.create')): ?>
                <a href="<?php echo e(route('houses.create')); ?>" class="flex h-10 items-center gap-2 rounded-xl bg-primary-600 px-4 text-sm font-medium text-white shadow-sm hover:bg-primary-700">
...
<?php endif; ?>
    ...
    <form method="GET" class="mb-4 grid grid-cols-1 gap-3 rounded-card border border-[var(--border)] bg-[var(--card-bg)] p-4 sm:grid-cols-2 lg:grid-cols-4">
        <input type="text" name="search" value="<?php echo e($filters['search'] ?? ''); ?>" placeholder="Cari nomor rumah/alamat…"
...
<?php endif; ?> Cari</button>
            <a href="<?php echo e(route('houses.index')); ?>" class="flex h-10 items-center justify-center rounded-xl border border-[var(--border)] px-3 text-sm text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5">Reset</a>
        </div>
    </form>

    <div class="overflow-hidden rounded-card border border-[var(--border)] bg-[var(--card-bg)] shadow-sm">
        <?php if($houses->isEmpty()): ?>
            <?php if (isset($component)) { $__componentOriginal074a021b9d42f490272b5eefda63257c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal074a021b9d42f490272b5eefda63257c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['icon' => 'home','title' => 'Belum ada data rumah','description' => 'Data akan muncul di sini setelah Operator Desa menambahkan rumah.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'home','title' => 'Belum ada data rumah','description' => 'Data akan muncul di sini setelah Operator Desa menambahkan rumah.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <tbody class="divide-y divide-[var(--border)]">
                        <?php $__currentLoopData = $houses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $house): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-slate-50 dark:hover:bg-white/5">
                                <td class="px-4 py-3 font-medium"><?php echo e($house->house_number ?? '—'); ?></td>
                                <td class="px-4 py-3 text-slate-500"><?php echo e($house->address ?? '—'); ?></td>
                                <td class="px-4 py-3 text-slate-500"><?php echo e($house->village?->name ?? '—'); ?></td>
...
<?php endif; ?></td>
                                <td class="px-4 py-3 text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        <a href="<?php echo e(route('houses.show', $house)); ?>" class="flex size-8 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-white/5"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></a>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rumah.update')): ?>
                                            <a href="<?php echo e(route('houses.edit', $house)); ?>" class="flex size-8 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-white/5"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?></a>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rumah.delete')): ?>
                                            <form method="POST" action="<?php echo e(route('houses.destroy', $house)); ?>" onsubmit="return confirm('Hapus data rumah ini?')">
...
<?php endif; ?></button>
            ...
            <div class="border-t border-[var(--border)] p-4"><?php echo e($houses->links()); ?></div>
        <?php endif; ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Portofolio\sik-ampel-laravel\resources\views/houses/index.blade.php ENDPATH**/ ?>