...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label', 'icon', 'available' => false, 'href' => '#']));
...
foreach (array_filter((['label', 'icon', 'available' => false, 'href' => '#']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php else: ?>
    <button
        type="button"
        x-data
        @click="$store.toast.show('<?php echo e($label); ?> belum tersedia', 'Modul ini akan dibangun pada fase pengembangan berikutnya.')"
        class="text-left"
    >
...
<?php endif; ?>
<?php /**PATH D:\Portofolio\sik-ampel-laravel\resources\views/components/quick-action.blade.php ENDPATH**/ ?>