...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.guest','data' => ['title' => 'Verifikasi Rumah']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Verifikasi Rumah']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'home','class' => 'size-7']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'home','class' => 'size-7']); ?>
...
<?php endif; ?>
                ...
                <dl class="mt-5 space-y-3 text-left text-sm">
                    <div class="flex justify-between border-b border-[var(--border)] pb-2">
                        ...
                        <dd class="font-medium"><?php echo e($house->house_number ?? '—'); ?></dd>
                    </div>
                    <div class="flex justify-between border-b border-[var(--border)] pb-2">
                        <dt class="text-slate-400">Desa</dt>
                        <dd class="font-medium"><?php echo e($house->village?->name ?? '—'); ?></dd>
                    </div>
                    <div class="flex justify-between border-b border-[var(--border)] pb-2">
                        <dt class="text-slate-400">Dusun / RT-RW</dt>
                        <dd class="font-medium"><?php echo e($house->hamlet?->name ?? '—'); ?> / <?php echo e($house->rtRw?->label() ?? '—'); ?></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-slate-400">Terdaftar Sejak</dt>
                        <dd class="font-medium"><?php echo e($house->created_at->translatedFormat('d F Y')); ?></dd>
                    </div>
                </dl>
...
<?php endif; ?>
<?php /**PATH D:\Portofolio\sik-ampel-laravel\resources\views/public/verify-house.blade.php ENDPATH**/ ?>